...
import { CircularProgress, Container, Grid, Pagination, PaginationItem } from '@mui/material'
...
const HomePage = () => {
    ...
    const { products, numberOfPage, isLoading } = useSelector(state => state.products)
